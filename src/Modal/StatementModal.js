...
const StatementModal = ({ showModal, setShowModal }) => {
  ...
  const handleSignatureModal = (data) => {
    const { accountNo, chequeLeaves } = data;
    if (accountNo === "" || chequeLeaves === "") {
  ...
  return (
    ...
    <>
      ...
      <div className={modalClass} id="popUpAccountWindow">
          ...
          <div className="modal-content">
            ...
            <div className="modal-header">
              ...
              <div className="modal-head">
                <h1 className="modal-title">Request Account Statement</h1>
              </div>
            </div>
            {/* <!-- body --> */}
                    ...
                    return (
                      <Form autoComplete="off">
                        ...
                        <div className="text-center">
                          <i>
                            Note: This process can also be done via signature.
                          </i>
                        </div>
                      </Form>
                    );
